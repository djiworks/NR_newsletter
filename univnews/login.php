	...
	<body>
		...
		<div class="container">
			<form class="form-signin input-xlarge">
				...
				<a href="index.php"><button class="btn btn-large btn-primary" type="button">Log in</button></a>
				<a href="registration.php"><button class="btn btn-large btn-primary pull-right" type="button" data-toggle='modal' data-target='#signUp'>Sign up</button></a>
			</form>
		</div>
			...
			<div class="modal-body">
				<form class="form-horizontal">
					...
					<div class="bs-docs-example">	
						<div class="control-group">
							<div class="controls">
								<button type="button" class="btn" data-toggle='modal' data-target='#registrationConplete'>Submit</button>
							</div>
						</div>
					</div>
				</form>
