      ...
      <div class="navbar-inner">
        <div class="container-fluid">
          ...
          <div class="nav-collapse collapse">
            ...
            <ul class="nav">
              <li><a href="index.php">University <span class="badge badge-important">1</span></a></li>
              <li><a href="interns.php">Interns</a></li>
              <li><a href="newsletter.php">Newsletter <span class="badge badge-important">2</span></a></li>
              <li class="active"><a href="guidelines.php"><i class="icon-question-sign icon-white"></i>&nbsp;Guidelines</a></li>
            </ul>
          </div><!--/.nav-collapse -->
        </div>
      </div>
